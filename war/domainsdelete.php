...
class cdomains_delete extends cdomains {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("domainslist.php"); // Prevent SQL injection, return to list
...
if ($domains_deleteTotalRecs <= 0) { // No record found, exit
	...
	$domains_delete->Page_Terminate("domainslist.php"); // Return to list
}
?>
...
?>
<form name="fdomainsdelete" id="fdomainsdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_domainsdelete" class="ewTable ewTableSeparate">
<?php echo $domains->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_domains_id" class="domains_id"><?php echo $domains->id->FldCaption() ?></span></td>
		<td><span id="elh_domains_name" class="domains_name"><?php echo $domains->name->FldCaption() ?></span></td>
	</tr>
	</thead>
	<tbody>
<?php
...
?>
	<tr<?php echo $domains->RowAttributes() ?>>
		<td<?php echo $domains->id->CellAttributes() ?>><span id="el<?php echo $domains_delete->RowCnt ?>_domains_id" class="control-group domains_id">
<span<?php echo $domains->id->ViewAttributes() ?>>
<?php echo $domains->id->ListViewValue() ?></span>
</span></td>
		<td<?php echo $domains->name->CellAttributes() ?>><span id="el<?php echo $domains_delete->RowCnt ?>_domains_name" class="control-group domains_name">
