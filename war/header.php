...
<?php } ?>
		<td id="ewContentColumn" class="ewContentColumn">
			<!-- right column (begin) -->
<div class="ewLangForm"><form class="ewForm form-horizontal">
<?php echo $Language->Phrase("Language") ?>
<select id="language" name="language" onchange="ew_SubmitLanguageForm(this.form);">
