...
?>
<form name="fuserdelete" id="fuserdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php echo $user->TableCustomInnerHtml ?>
	...
	<tr class="ewTableHeader">
		<td><span id="elh_user_iduser" class="user_iduser"><?php echo $user->iduser->FldCaption() ?></span></td>
		<td><span id="elh_user__login" class="user__login"><?php echo $user->_login->FldCaption() ?></span></td>
...
?>
	<tr<?php echo $user->RowAttributes() ?>>
		<td<?php echo $user->iduser->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user_iduser" class="control-group user_iduser">
<span<?php echo $user->iduser->ViewAttributes() ?>>
<?php echo $user->iduser->ListViewValue() ?></span>
</span></td>
		<td<?php echo $user->_login->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user__login" class="control-group user__login">
<span<?php echo $user->_login->ViewAttributes() ?>>
<?php echo $user->_login->ListViewValue() ?></span>
</span></td>
		<td<?php echo $user->password->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user_password" class="control-group user_password">
<span<?php echo $user->password->ViewAttributes() ?>>
<?php echo $user->password->ListViewValue() ?></span>
</span></td>
		<td<?php echo $user->_email->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user__email" class="control-group user__email">
