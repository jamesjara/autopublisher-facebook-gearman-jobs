...
$credenciales_view = NULL; // Initialize page object first

class ccredenciales_view extends ccredenciales {
	...
	// Page object name
	var $PageObjName = 'credenciales_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "credencialeslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "credencialeslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "credencialeslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($credenciales_view)) $credenciales_view = new ccredenciales_view();

// Page init
$credenciales_view->Page_Init();

// Page main
$credenciales_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$credenciales_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var credenciales_view = new ew_Page("credenciales_view");
credenciales_view.PageID = "view"; // Page ID
var EW_PAGE_ID = credenciales_view.PageID; // For backward compatibility

// Form object
var fcredencialesview = new ew_Form("fcredencialesview");

// Form_CustomValidate event
fcredencialesview.Form_CustomValidate = 
...
fcredencialesview.ValidateRequired = true;
<?php } else { ?>
fcredencialesview.ValidateRequired = false; 
<?php } ?>
...
<?php $credenciales_view->ExportOptions->Render("body") ?>
<?php if (!$credenciales_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($credenciales_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $credenciales_view->ShowPageHeader(); ?>
<?php
$credenciales_view->ShowMessage();
?>
<form name="fcredencialesview" id="fcredencialesview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="credenciales">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_credencialesview" class="table table-bordered table-striped">
<?php if ($credenciales->id->Visible) { // id ?>
	<tr id="r_id"<?php echo $credenciales->RowAttributes() ?>>
		<td><span id="elh_credenciales_id"><?php echo $credenciales->id->FldCaption() ?></span></td>
		<td<?php echo $credenciales->id->CellAttributes() ?>><span id="el_credenciales_id" class="control-group">
<span<?php echo $credenciales->id->ViewAttributes() ?>>
<?php echo $credenciales->id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $credenciales->domainid->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $credenciales->nombre->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $credenciales->app->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $credenciales->secret->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
...
<script type="text/javascript">
fcredencialesview.Init();
</script>
<?php
$credenciales_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$credenciales_view->Page_Terminate();
?>
