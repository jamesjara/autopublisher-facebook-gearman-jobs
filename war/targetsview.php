...
$targets_view = NULL; // Initialize page object first

class ctargets_view extends ctargets {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "targetslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "targetslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "targetslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($targets_view)) $targets_view = new ctargets_view();

// Page init
$targets_view->Page_Init();

// Page main
$targets_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$targets_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var targets_view = new ew_Page("targets_view");
targets_view.PageID = "view"; // Page ID
var EW_PAGE_ID = targets_view.PageID; // For backward compatibility

// Form object
var ftargetsview = new ew_Form("ftargetsview");

// Form_CustomValidate event
ftargetsview.Form_CustomValidate = 
...
ftargetsview.ValidateRequired = true;
<?php } else { ?>
ftargetsview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftargetsview.Lists["x_domainid"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $targets_view->ExportOptions->Render("body") ?>
<?php if (!$targets_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($targets_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $targets_view->ShowPageHeader(); ?>
<?php
$targets_view->ShowMessage();
?>
<form name="ftargetsview" id="ftargetsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="targets">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_targetsview" class="table table-bordered table-striped">
...
<?php echo $targets->id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $targets->domainid->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($targets->fid->Visible) { // fid ?>
	<tr id="r_fid"<?php echo $targets->RowAttributes() ?>>
		<td><span id="elh_targets_fid"><?php echo $targets->fid->FldCaption() ?></span></td>
...
<?php echo $targets->fid->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $targets->categoria->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($targets->name->Visible) { // name ?>
	<tr id="r_name"<?php echo $targets->RowAttributes() ?>>
		<td><span id="elh_targets_name"><?php echo $targets->name->FldCaption() ?></span></td>
...
<?php echo $targets->name->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
