...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("postslist.php"); // Exit and go to default page
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("jobslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("jobshistoricallist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("userlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("audittraillist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("target_categoriaslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("domainslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("targetslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("credencialeslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("getjobslist.php");
		if ($Security->IsLoggedIn()) {
