...
define("EW_PROJECT_NAME", "socialcms", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{A78C9F64-F701-4951-8B68-9678633E190C}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'og7C7APXo42k75vw', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/socialcms.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'socialcms', TRUE);
define("EW_CONN_PASS", '87944598', TRUE);
define("EW_CONN_DB", 'socialcms', TRUE);
...
define("EW_ADMIN_PASSWORD", "87944598", TRUE); // Administrator password
...
// Use mobile menu
$EW_USE_MOBILE_MENU = FALSE;

// Reflow for mobile
define("EW_MOBILE_REFLOW", FALSE, TRUE);
