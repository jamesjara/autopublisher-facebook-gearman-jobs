	...
	function Page_Main() {
		...
		if ($bPostBack && $bValidate) {
			...
			if ($rs = $conn->Execute($sSql)) {
				if (!$rs->EOF) {
					$rsold = $rs->fields;
					if (ew_ComparePassword($rsold['metadata'], $this->OldPassword)) {
						$bValidPwd = TRUE;
						$bValidPwd = $this->User_ChangePassword($rsold, $sUsername, $this->OldPassword, $this->NewPassword);
						if ($bValidPwd) {
							$rsnew = array('metadata' => $this->NewPassword); // Change Password
							$rs->Close();
...
<div class="ewChangepwdContent">
	<div class="control-group">
		...
		<div class="controls"><input type="password" name="opwd" id="opwd" class="input-large"></div>
	</div>
	<div class="control-group">
		<label class="control-label" for="npwd"><?php echo $Language->Phrase("NewPassword") ?></label>
		<div class="controls"><input type="password" name="npwd" id="npwd" class="input-large"></div>
	</div>
	<div class="control-group">
		<label class="control-label" for="cpwd"><?php echo $Language->Phrase("ConfirmPassword") ?></label>
		<div class="controls"><input type="password" name="cpwd" id="cpwd" class="input-large"></div>
	</div>
	<div class="control-group">
		<div class="controls">
