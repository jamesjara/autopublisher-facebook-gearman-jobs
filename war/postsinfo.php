...
//
// Table class for posts
//
class cposts extends cTable {
	var $id;
	var $message;
	var $picture;
	var $link;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('posts', 'posts', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// message
		$this->message = new cField('posts', 'posts', 'x_message', 'message', '`message`', '`message`', 201, -1, FALSE, '`message`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['message'] = &$this->message;

		// picture
		$this->picture = new cField('posts', 'posts', 'x_picture', 'picture', '`picture`', '`picture`', 201, -1, FALSE, '`picture`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['picture'] = &$this->picture;

		// link
		$this->link = new cField('posts', 'posts', 'x_link', 'link', '`link`', '`link`', 201, -1, FALSE, '`link`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['link'] = &$this->link;

		// name
		$this->name = new cField('posts', 'posts', 'x_name', 'name', '`name`', '`name`', 201, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// description
		$this->description = new cField('posts', 'posts', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['description'] = &$this->description;

		// action_name
		$this->action_name = new cField('posts', 'posts', 'x_action_name', 'action_name', '`action_name`', '`action_name`', 201, -1, FALSE, '`action_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['action_name'] = &$this->action_name;

		// action_link
		$this->action_link = new cField('posts', 'posts', 'x_action_link', 'action_link', '`action_link`', '`action_link`', 201, -1, FALSE, '`action_link`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("postsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("postsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("postsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("postsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("postsdelete.php", $this->UrlParm());
	}
