...
//
// Table class for targets
//
class ctargets extends cTable {
	var $id;
	var $domainid;
	var $fid;
	var $categoria;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('targets', 'targets', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// domainid
		$this->domainid = new cField('targets', 'targets', 'x_domainid', 'domainid', '`domainid`', '`domainid`', 3, -1, FALSE, '`domainid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->domainid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['domainid'] = &$this->domainid;

		// fid
		$this->fid = new cField('targets', 'targets', 'x_fid', 'fid', '`fid`', '`fid`', 200, -1, FALSE, '`fid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['fid'] = &$this->fid;

		// categoria
		$this->categoria = new cField('targets', 'targets', 'x_categoria', 'categoria', '`categoria`', '`categoria`', 3, -1, FALSE, '`categoria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->categoria->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['categoria'] = &$this->categoria;

		// name
		$this->name = new cField('targets', 'targets', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("targetsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("targetsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "targetsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("targetsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("targetsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("targetsdelete.php", $this->UrlParm());
	}
