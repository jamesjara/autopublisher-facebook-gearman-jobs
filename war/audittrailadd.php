...
?>
<form name="faudittrailadd" id="faudittrailadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($audittrail->datetime->Visible) { // datetime ?>
	<tr id="r_datetime"<?php echo $audittrail->RowAttributes() ?>>
		...
		<td<?php echo $audittrail->datetime->CellAttributes() ?>><span id="el_audittrail_datetime" class="control-group">
...
<?php if ($audittrail->script->Visible) { // script ?>
	<tr id="r_script"<?php echo $audittrail->RowAttributes() ?>>
		...
		<td<?php echo $audittrail->script->CellAttributes() ?>><span id="el_audittrail_script" class="control-group">
...
<?php if ($audittrail->user->Visible) { // user ?>
	<tr id="r_user"<?php echo $audittrail->RowAttributes() ?>>
		...
		<td<?php echo $audittrail->user->CellAttributes() ?>><span id="el_audittrail_user" class="control-group">
...
<?php if ($audittrail->action->Visible) { // action ?>
	<tr id="r_action"<?php echo $audittrail->RowAttributes() ?>>
		...
		<td<?php echo $audittrail->action->CellAttributes() ?>><span id="el_audittrail_action" class="control-group">
...
<?php if ($audittrail->_table->Visible) { // table ?>
	<tr id="r__table"<?php echo $audittrail->RowAttributes() ?>>
		...
		<td<?php echo $audittrail->_table->CellAttributes() ?>><span id="el_audittrail__table" class="control-group">
...
<?php if ($audittrail->_field->Visible) { // field ?>
	<tr id="r__field"<?php echo $audittrail->RowAttributes() ?>>
		...
		<td<?php echo $audittrail->_field->CellAttributes() ?>><span id="el_audittrail__field" class="control-group">
...
<?php if ($audittrail->keyvalue->Visible) { // keyvalue ?>
	<tr id="r_keyvalue"<?php echo $audittrail->RowAttributes() ?>>
		...
		<td<?php echo $audittrail->keyvalue->CellAttributes() ?>><span id="el_audittrail_keyvalue" class="control-group">
...
<?php if ($audittrail->oldvalue->Visible) { // oldvalue ?>
	<tr id="r_oldvalue"<?php echo $audittrail->RowAttributes() ?>>
		...
		<td<?php echo $audittrail->oldvalue->CellAttributes() ?>><span id="el_audittrail_oldvalue" class="control-group">
...
<?php if ($audittrail->newvalue->Visible) { // newvalue ?>
	<tr id="r_newvalue"<?php echo $audittrail->RowAttributes() ?>>
		...
		<td<?php echo $audittrail->newvalue->CellAttributes() ?>><span id="el_audittrail_newvalue" class="control-group">
