...
$credenciales_edit = NULL; // Initialize page object first

class ccredenciales_edit extends ccredenciales {
	...
	// Page object name
	var $PageObjName = 'credenciales_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("credencialeslist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// secret
			$this->secret->SetDbValueDef($rsnew, $this->secret->CurrentValue, NULL, $this->secret->ReadOnly);
...
// Create page object
if (!isset($credenciales_edit)) $credenciales_edit = new ccredenciales_edit();

// Page init
$credenciales_edit->Page_Init();

// Page main
$credenciales_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$credenciales_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var credenciales_edit = new ew_Page("credenciales_edit");
credenciales_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = credenciales_edit.PageID; // For backward compatibility

// Form object
var fcredencialesedit = new ew_Form("fcredencialesedit");

// Validate form
fcredencialesedit.Validate = function() {
...
fcredencialesedit.Form_CustomValidate = 
...
fcredencialesedit.ValidateRequired = true;
<?php } else { ?>
fcredencialesedit.ValidateRequired = false; 
<?php } ?>
...
<?php $credenciales_edit->ShowPageHeader(); ?>
<?php
$credenciales_edit->ShowMessage();
?>
<form name="fcredencialesedit" id="fcredencialesedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="credenciales">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_credencialesedit" class="table table-bordered table-striped">
...
<?php echo $credenciales->id->EditValue ?></span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($credenciales->id->CurrentValue) ?>">
</span><?php echo $credenciales->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fcredencialesedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$credenciales_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$credenciales_edit->Page_Terminate();
?>
