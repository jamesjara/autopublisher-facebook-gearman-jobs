...
class cforgotpwd extends cuser {
...
<div class="ewForgotpwdContent">
	<div class="control-group">
		...
		<div class="controls"><input type="text" name="email" id="email" class="input-large" value="<?php ew_HtmlEncode($forgotpwd->Email) ?>" size="30" maxlength="45"></div>
	</div>
	<div class="control-group">
		<div class="controls">
