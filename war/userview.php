...
class cuser_view extends cuser {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["iduser"] <> "") {
			$this->RecKey["iduser"] = $_GET["iduser"];
			$KeyUrl .= "&iduser=" . urlencode($this->RecKey["iduser"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["iduser"] <> "") {
				...
				$this->RecKey["iduser"] = $this->iduser->QueryStringValue;
			} else {
...
?>
<form name="fuserview" id="fuserview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php echo $user->iduser->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $user->_login->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<span<?php echo $user->metadata->ViewAttributes() ?>>
<?php echo $user->metadata->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
