...
?>
<form name="faudittraildelete" id="faudittraildelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
?>
	<tr<?php echo $audittrail->RowAttributes() ?>>
		<td<?php echo $audittrail->id->CellAttributes() ?>><span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_id" class="control-group audittrail_id">
<span<?php echo $audittrail->id->ViewAttributes() ?>>
<?php echo $audittrail->id->ListViewValue() ?></span>
</span></td>
		<td<?php echo $audittrail->datetime->CellAttributes() ?>><span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_datetime" class="control-group audittrail_datetime">
<span<?php echo $audittrail->datetime->ViewAttributes() ?>>
<?php echo $audittrail->datetime->ListViewValue() ?></span>
</span></td>
		<td<?php echo $audittrail->script->CellAttributes() ?>><span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_script" class="control-group audittrail_script">
<span<?php echo $audittrail->script->ViewAttributes() ?>>
<?php echo $audittrail->script->ListViewValue() ?></span>
</span></td>
		<td<?php echo $audittrail->user->CellAttributes() ?>><span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_user" class="control-group audittrail_user">
<span<?php echo $audittrail->user->ViewAttributes() ?>>
<?php echo $audittrail->user->ListViewValue() ?></span>
</span></td>
		<td<?php echo $audittrail->action->CellAttributes() ?>><span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_action" class="control-group audittrail_action">
<span<?php echo $audittrail->action->ViewAttributes() ?>>
<?php echo $audittrail->action->ListViewValue() ?></span>
</span></td>
		<td<?php echo $audittrail->_table->CellAttributes() ?>><span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail__table" class="control-group audittrail__table">
<span<?php echo $audittrail->_table->ViewAttributes() ?>>
<?php echo $audittrail->_table->ListViewValue() ?></span>
</span></td>
		<td<?php echo $audittrail->_field->CellAttributes() ?>><span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail__field" class="control-group audittrail__field">
